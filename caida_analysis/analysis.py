...
def analyze_algebraic_connectivity(G, sample_size=3000, trials=5):
    ...
    Uses undirected projection, which is standard for robustness analysis.
    """
    print(f"\n[4/5] Computing Algebraic Connectivity (Spectral Robustness)...")

    # Ignore edge directions (for some reason this breaks otherwise even tho graph shouldn't be directed)
    Gu = G.to_undirected()

    # Remove isolated nodes (required: Laplacian assumes connected components)
...
if __name__ == "__main__":
    ...
    # Config
    FILE_PATH = "C:\\Users\\andri\\Desktop\\AS attempt\\20251201.as-rel.txt"
    #FILE_PATH = "C:\\Users\\andri\\Desktop\\AS attempt\\comparison.txt"
